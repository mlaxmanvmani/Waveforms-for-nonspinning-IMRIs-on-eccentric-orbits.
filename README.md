...
The supplemental file (supplemental_material_arxiv2602.21018v1.m) lists Gravitational Wave Phasing (Taylor approximants) and Amplitude (spherical harmonic modes) computed through 5PN order and to $10^{\rm th}$ power in the eccentricity parameter. Inputs required to arrive at the final results are also included. More specifically,   
